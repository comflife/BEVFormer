# Language-Guided BEVFormer-MQA with CLIP (tiny)
#
# This config uses CLIP instead of BERT for text encoding.
#
# Key changes from bevformer_mqa_tiny.py:
# - Text encoder: CLIP-ViT-Base-Patch32 (replaces BERT)
# - Faster training and better vision-language alignment
# - Pre-trained on multi-view images + QA text pairs
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(project='difffp', name='bevformer_mqa_clip_tiny_training'),
        ),
    ],
)
